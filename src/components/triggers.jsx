...
const Triggers = ({
  ...
  return (
    <>
      ...
      <ButtonsRow>
        <Button onClick={() => copyToClipboard(getSvg(darkColors, mainColor, lightColors))}>
          {t('copySvg')}
        </Button>

        <Button onClick={() => copyToClipboard(getColorsListText(darkColors, mainColor, lightColors))}>
          {t('copyColors')}
        </Button>

        <Button onClick={() => randomState()}>{t('randomizeAll')}</Button>
        <Button onClick={() => randomColor()}>{t('randomizeColor')}</Button>
      </ButtonsRow>
    </>
  )
}
